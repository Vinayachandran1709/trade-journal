    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-500">
          Choose your broker to import trade history
        </p>
      </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <Card className="flex flex-col">
          ...
          <p className="mt-4 flex-1 text-sm text-gray-500">
            Upload your Groww trades CSV file exported from the Groww app or
            website.
          </p>
      ...
      <div className="mt-8 rounded-xl border border-gray-200 bg-gray-50 p-5">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Support for Upstox, Angel One, ICICI Direct, and more brokers is in
          progress.
        </p>
      </div>
    </div>
